...
export async function GET() {
    try 
    {
        ...
        const Query = `
                    ...
                    ROUND(AVG(duree)) AS averageDurationSeconds
                    FROM videos
    ...
    {
        console.log('error in api : Average duration by year',error)
        return NextResponse.json({ error: 'Failed to fetch average duration  by year' }, { status: 500 });
    }
